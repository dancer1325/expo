...
> **info** **New to programming?** You can build this same app by prompting an AI coding agent instead of writing the code yourself. Follow the [Build with AI tutorial](/tutorial/build-with-ai/introduction/). It covers setup from scratch.
