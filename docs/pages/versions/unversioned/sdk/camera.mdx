...
* `expo-camera`
  * 👀React component / renders a preview of the device's front or back camera 👀
    * camera's parameters can be adjusted (_Example:_ zoom, torch, and flash mode)
    * `CameraView` enables take photos and record videos / saved | app's cache
    * detect bar codes / appear | preview
...
* ⚠️ ONLY ALLOWED 1! Camera preview active / ANY given time ⚠️
  * if you have MULTIPLE screens | your app -> unmount `Camera` components | screen is unfocused
* run | your device -- to see -- ALL features working together
