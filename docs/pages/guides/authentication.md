...
* `AuthSession`
  * uses
    * | ANY 
      * OAuth provider,
        * _Example:_ Calendly, Coinbase, Dropbox, Fitbit, GitHub, Imgur, Reddit, Slack, Spotify, Strava, Twitch, Twitter, Uber
      * OpenID Connect provider
        * _Example:_ 
          * [IdentityServer 4](https://demo.identityserver.io/), 
          * [Asgardeo](https://wso2.com/asgardeo/docs/guides/#developer-guide), 
          * [Azure](https://docs.microsoft.com/en-us/azure/active-directory/develop/v2-overview),
          * Beyond Identity, 
          * Cognito, 
          * Descope, 
          * Keycloak, 
...
* OTHER authentication methods / ❌NOT AuthSession❌
  * [Apple](../versions/unversioned/sdk/apple-authentication)
  * specific guides
