...
<FileTree files={['src/app/index.tsx', ['src/app/hello+api.ts', 'API Route']]} />
...
> **important** This is an [alpha](/more/release-statuses/#alpha) feature. The process will be more automated and have better support in future versions.
