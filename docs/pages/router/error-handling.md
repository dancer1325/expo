...
* goal
  * | use Expo Router,
    * how to handle unmatched routes & errors | your app 

## Unmatched routes

![](../../public/static/images/expo-router/unmatched.png)
...
React Native LogBox needs to be presented less aggressively to develop with errors
* Currently, it shows for `console.error` and `console.warn`
