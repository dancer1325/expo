...
is used to handle deep links into your app that don't match a specific route, such as links generated by third-party services.
...
> **important** `legacy_subscribe` is in [alpha](/more/release-statuses/#alpha) and is available in SDK 52.
