...
* ways to use
  ...
  * [build it -- from -- source](#building-expo-go)
  * open | https://expo.dev/go

* [ios/Exponent.xcworkspace](ios/Exponent.xcworkspace)
  * == Xcode workspace
  * uses
...
You can build the React Native Android dep using `./gradlew :packages:react-native:ReactAndroid:buildCMakeDebug` in `react-native-lab/react-native` directory
* This is optional because React Native will be built anyway when you build Expo Go, but can help to narrow down a potential issue surface area.
